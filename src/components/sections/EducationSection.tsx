      ...
      <div className="space-y-8 max-w-4xl mx-auto">
        ...
        <div className="group bg-white dark:bg-neutral-900 rounded-lg p-6 shadow-lg border border-neutral-200 dark:border-neutral-800 relative overflow-hidden transition-all duration-300 transform hover:-translate-y-2 hover:shadow-xl hover:shadow-blue-600/25 hover:drop-shadow-[0_0_12px_rgba(37,99,235,0.7)]">
          ...
          <div className="flex items-start space-x-4">
            <div className="bg-blue-100 dark:bg-blue-900/30 p-3 rounded-full transition-transform duration-300 group-hover:scale-110 group-hover:shadow-2xl group-hover:drop-shadow-[0_0_8px_rgba(37,99,235,0.5)]">
        ...
        {/* Higher Secondary */}
        <div className="group bg-white dark:bg-neutral-900 rounded-lg p-6 shadow-lg border border-neutral-200 dark:border-neutral-800 relative overflow-hidden transition-all duration-300 transform hover:-translate-y-2 hover:shadow-xl hover:shadow-purple-600/25 hover:drop-shadow-[0_0_12px_rgba(147,51,234,0.7)]">
          ...
          <div className="flex items-start space-x-4">
            <div className="bg-purple-100 dark:bg-purple-900/30 p-3 rounded-full transition-transform duration-300 group-hover:scale-110 group-hover:shadow-2xl group-hover:drop-shadow-[0_0_8px_rgba(147,51,234,0.5)]">
        ...
        {/* Secondary School */}
        <div className="group bg-white dark:bg-neutral-900 rounded-lg p-6 shadow-lg border border-neutral-200 dark:border-neutral-800 relative overflow-hidden transition-all duration-300 transform hover:-translate-y-2 hover:shadow-xl hover:shadow-orange-600/25 hover:drop-shadow-[0_0_12px_rgba(234,88,12,0.7)]">
          ...
          <div className="flex items-start space-x-4">
            <div className="bg-orange-100 dark:bg-orange-900/30 p-3 rounded-full transition-transform duration-300 group-hover:scale-110 group-hover:shadow-2xl group-hover:drop-shadow-[0_0_8px_rgba(234,88,12,0.5)]">
