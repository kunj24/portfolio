      ...
      <div className="space-y-6 sm:space-y-8 max-w-4xl mx-auto">
        ...
        <div className="education-card group bg-white dark:bg-neutral-900 rounded-lg p-4 sm:p-6 shadow-lg border border-neutral-200 dark:border-neutral-800 relative overflow-hidden transition-all duration-300 transform md:hover:-translate-y-2 md:hover:shadow-xl md:hover:shadow-blue-600/25 md:hover:drop-shadow-[0_0_12px_rgba(37,99,235,0.7)] touch-manipulation">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start space-y-3 sm:space-y-0 sm:space-x-4">
            <div className="bg-blue-100 dark:bg-blue-900/30 p-3 rounded-full transition-transform duration-300 md:group-hover:scale-110 md:group-hover:shadow-2xl md:group-hover:drop-shadow-[0_0_8px_rgba(37,99,235,0.5)] self-center sm:self-start">
        ...
        <div className="group bg-white dark:bg-neutral-900 rounded-lg p-4 sm:p-6 shadow-lg border border-neutral-200 dark:border-neutral-800 relative overflow-hidden transition-all duration-300 transform md:hover:-translate-y-2 md:hover:shadow-xl md:hover:shadow-purple-600/25 md:hover:drop-shadow-[0_0_12px_rgba(147,51,234,0.7)] touch-manipulation">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start space-y-3 sm:space-y-0 sm:space-x-4">
            <div className="bg-purple-100 dark:bg-purple-900/30 p-3 rounded-full transition-transform duration-300 md:group-hover:scale-110 md:group-hover:shadow-2xl md:group-hover:drop-shadow-[0_0_8px_rgba(147,51,234,0.5)] self-center sm:self-start">
        ...
        <div className="group bg-white dark:bg-neutral-900 rounded-lg p-4 sm:p-6 shadow-lg border border-neutral-200 dark:border-neutral-800 relative overflow-hidden transition-all duration-300 transform md:hover:-translate-y-2 md:hover:shadow-xl md:hover:shadow-orange-600/25 md:hover:drop-shadow-[0_0_12px_rgba(234,88,12,0.7)] touch-manipulation">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start space-y-3 sm:space-y-0 sm:space-x-4">
            <div className="bg-orange-100 dark:bg-orange-900/30 p-3 rounded-full transition-transform duration-300 md:group-hover:scale-110 md:group-hover:shadow-2xl md:group-hover:drop-shadow-[0_0_8px_rgba(234,88,12,0.5)] self-center sm:self-start">
