  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 max-w-6xl">
      ...
      <div className="space-y-6 sm:space-y-8 max-w-4xl mx-auto">
        {/* Bachelor's Degree */}
        <div className="education-card group bg-neutral-900 rounded-lg p-5 sm:p-6 shadow-lg border border-[#2ee6c1]/20 relative overflow-hidden transition-all duration-300 transform md:hover:-translate-y-2 md:hover:shadow-xl md:hover:shadow-blue-600/25 md:hover:drop-shadow-[0_0_12px_rgba(37,99,235,0.7)] touch-manipulation">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start space-y-3 sm:space-y-0 sm:space-x-4">
            <div className="bg-blue-900/30 p-3 rounded-full transition-transform duration-300 md:group-hover:scale-110 md:group-hover:shadow-2xl md:group-hover:drop-shadow-[0_0_8px_rgba(37,99,235,0.5)] self-center sm:self-start flex-shrink-0">
              <GraduationCap className="h-6 w-6 text-blue-400 transition-transform duration-300 md:group-hover:scale-110" />
            </div>
            <div className="flex-1 text-center sm:text-left">
              <h3 className="text-base sm:text-lg md:text-xl font-bold text-neutral-100 mb-2 leading-tight">
        ...
        {/* Higher Secondary */}
        <div className="group bg-neutral-900 rounded-lg p-5 sm:p-6 shadow-lg border border-[#2ee6c1]/20 relative overflow-hidden transition-all duration-300 transform md:hover:-translate-y-2 md:hover:shadow-xl md:hover:shadow-purple-600/25 md:hover:drop-shadow-[0_0_12px_rgba(147,51,234,0.7)] touch-manipulation">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start space-y-4 sm:space-y-0 sm:space-x-4">
            <div className="bg-purple-900/30 p-3 rounded-full transition-transform duration-300 md:group-hover:scale-110 md:group-hover:shadow-2xl md:group-hover:drop-shadow-[0_0_8px_rgba(147,51,234,0.5)] self-center sm:self-start flex-shrink-0">
              <GraduationCap className="h-6 w-6 text-purple-400 transition-transform duration-300 md:group-hover:scale-110" />
            </div>
            <div className="flex-1 text-center sm:text-left">
              <h3 className="text-base sm:text-lg md:text-xl font-bold text-neutral-100 mb-2 leading-tight">
        ...
        {/* Secondary School */}
        <div className="group bg-neutral-900 rounded-lg p-5 sm:p-6 shadow-lg border border-[#2ee6c1]/20 relative overflow-hidden transition-all duration-300 transform md:hover:-translate-y-2 md:hover:shadow-xl md:hover:shadow-orange-600/25 md:hover:drop-shadow-[0_0_12px_rgba(234,88,12,0.7)] touch-manipulation">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start space-y-4 sm:space-y-0 sm:space-x-4">
            <div className="bg-orange-900/30 p-3 rounded-full transition-transform duration-300 md:group-hover:scale-110 md:group-hover:shadow-2xl md:group-hover:drop-shadow-[0_0_8px_rgba(234,88,12,0.5)] self-center sm:self-start flex-shrink-0">
              <GraduationCap className="h-6 w-6 text-orange-400 transition-transform duration-300 md:group-hover:scale-110" />
            </div>
            <div className="flex-1 text-center sm:text-left">
              <h3 className="text-base sm:text-lg md:text-xl font-bold text-neutral-100 mb-2 leading-tight">
