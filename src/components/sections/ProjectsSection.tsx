      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mt-16">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-8 py-4 bg-blue-600 text-white rounded-lg font-medium transition-all duration-300 hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-600/25 hover:drop-shadow-[0_0_12px_rgba(37,99,235,0.7)] hover:transform hover:scale-105"
          >
